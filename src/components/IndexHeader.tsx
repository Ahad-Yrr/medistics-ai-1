            ...
            <div className="container mx-auto px-4 lg:px-8 py-4 flex justify-between items-center max-w-7xl">
                ...
                <nav className="hidden md:flex items-center space-x-8 relative font-bold">
                                ...
                                <ul className="space-y-4 text-base">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            className="flex items-center space-x-3 hover:text-[#EA4335]"
                                        >
                                            <FaEnvelope className="w-5 h-5" /> <span>contact@medmacs.app</span>
                                        </a>
                                    </li>
                                </ul>
                            </PopoverWrapper>
                    ...
                    <div className="relative group">
                        ...
                        <div className="hidden group-hover:block">
                            <PopoverWrapper>
                                <h4 className="font-semibold mb-4 text-lg">List of availiable plans</h4>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    {pricing.map((p) => (
                                        <div
                                            key={p.id}
                                            className="p-4 rounded-xl border border-current/30 shadow-md hover:shadow-lg transition text-center"
                                        >
                                            <div className="font-semibold">{p.display_name}</div>
                                        </div>
                                    ))}
                                </div>
                                <h4 className="mb-2 text-m">Visit our Pricing page to catch exciting prices on our Monthly and Yearly Planss</h4>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                    <div className="flex flex-col items-center">
                                        <img
                                            ...
                                            className="w-24 h-24 rounded-full border-2 border-current/50 shadow-lg mb-2"
                                        />
                                        <div className="font-bold">Dr Muhammad Ameer Hamza</div>
                                        <div className="text-sm font-medium opacity-80">Co-Founder</div>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <img
                                            src="/team/founders/ahad.png"
                                            alt="Hafiz Abdul Ahad"
                                            className="w-24 h-24 rounded-full border-2 border-current/50 shadow-lg mb-2"
                                        />
                                        <div className="font-bold">Hafiz Abdul Ahad</div>
                                        <div className="text-sm font-medium opacity-80">Co-Founder</div>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <img
                                            src="/team/founders/aima.png"
                                            alt="Aima Khan"
                                            className="w-24 h-24 rounded-full border-2 border-current/50 shadow-lg mb-2"
                                        />
                                        <div className="font-bold">Aima Khan</div>
                                        <div className="text-sm font-medium opacity-80">Co-Founder</div>
                                    </div>
                                </div>
                                <div className="mt-6 text-center text-sm opacity-80 border-t border-current/30 pt-3">
                                    More team members will be disclosed soon.
                                </div>
                            </PopoverWrapper>
                        </div>
                    </div>
